...
const navItems: readonly NavItem[] = [
  ...
  },
  {
    ...
    to: '/audit-log',
    adminOnly: true,
    icon: ['M12 6.75a.75.75 0 01.75.75v4.19l2.72 2.72a.75.75 0 11-1.06 1.06l-3-3a.75.75 0 01-.22-.53V7.5a.75.75 0 01.75-.75z', 'M21.75 12a9.75 9.75 0 11-19.5 0 9.75 9.75 0 0119.5 0z']
  },
  {
    name: 'settings',
    label: 'Pengaturan',
...
const visibleNavItems = computed<readonly NavItem[]>(() =>
  navItems.filter((item) => {
    ...
    if (item.personelOnly && role !== 'admin' && role !== 'kyai') return false
    return true
  })
)
